...
* `moat-nob.js` - This is your partner module file, by default it contains a template divided into multiple sections which need to be completed.
* `moat-nob-validator.js` - This is the validator file for the configuration object that will be passed into your module.
* `moat-nob-exports.js` - A file that contains all of the modules exports (i.e. any functions that need to be exposed to the outside world).

## <a name='gettingStarted'></a>Getting Started
1. <b>Complete the moat-nob.js file</b>
    * moat-nob.js is where all of your adapter code will live.
...
2. <b>Complete the moat-nob-validator.js file</b>
...
3. <b>Complete the moat-nob-exports.js file</b>
    * This file will contain any functions that need to be exported or exposed to the outside world. Things like render functions, custom callbacks, etc. Any legacy render functions will also need to be exposed here. Anything added to the `shellInterface.MoatNob` will be accessible through `window.headertag.MoatNob`
...
In this section you will be filling out the moat-nob.js, moat-nob-exports.js, and the moat-nob-validator.js files to create your module.

### Step 0: Config Validation (`moat-nob-validator.js`)
...
### Step 2: Generate Request URL (`moat-nob.js`)
...
### Step 3: Response Callback (`moat-nob.js`)
...
### Step 4: Parsing and Storing Demand (`moat-nob.js`)
...
```javascript
{
    ...
    "targetingType": "slot"
    "targeting" : {
        "ix_moat_id": ["_230l09jd2"],
        "ix_moat_cpm": ["300x250_2.50"]
    },
    "price": 2.50,
    "size": [300,250],
...
### Step 5: Rendering Pixel (`moat-nob.js`)
...
### Step 6: Exports (`moat-nob-exports.js`)
...
```javascript
shellInterface.MoatNob = { //shell interface is the window variable that is accessible through the window object, currently this will always be window.headertag
    render: SpaceCamp.services.RenderService.renderDfpAd.bind(null, 'MoatNob')
};
```
...
```javascript
if (__directInterface.Layers.PartnersLayer.Partners.MoatNob) {
    shellInterface.MoatNob = shellInterface.MoatNob || {};
    shellInterface.MoatNob.adResponseCallback = __directInterface.Layers.PartnersLayer.Partners.MoatNob.adResponseCallback;
}
```
...
if (__directInterface.Layers.PartnersLayer.Partners.MoatNob) {
    shellInterface.MoatNob = shellInterface.MoatNob || {};
    shellInterface.MoatNob.adResponseCallbacks = __directInterface.Layers.PartnersLayer.Partners.MoatNob.adResponseCallbacks;
}
```
